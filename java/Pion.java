...
public class Pion {
	...
	/**
	 * Retourne le numero d'un joueur
	 * @return
	 */
	public int getP(){
		return p;
	...
	/**
	 * Constructeur pour un pion avec le numero p.
	 */
	public Pion(int p) {
		super();
		this.p = p;
	...
	/**
	 * Renvoie un String avec le numero concatene a des code ANSI pour afficher de la couleur dans les temrinaux qui le supportent.
	 * @param c Couleur dans laquelle afficher le numero
